  ...
  return (
    ...
    >
      ...
      <Paragraph style={{ fontSize: 15, lineHeight: 2 }}>
        בית ספר בית יעקב הוא מוסד חינוכי ייחודי הפועל למען חינוך הבנות על פי ערכי התורה והמסורת היהודית.
        המוסד מאמין כי כל בת היא עולם ומלואו, ושואף לטפח בכל תלמידה את הכישרונות, הערכים והאמונה
        שיובילו אותה לחיים של משמעות ותרומה לעם ישראל.
      </Paragraph>

      <Paragraph style={{ fontSize: 15, lineHeight: 2 }}>
        אנו מציעים סביבה לימודית חמה ותומכת, שבה כל תלמידה מקבלת את הכלים הדרושים לה — הן בלימודי
